...
export const INSTANCE_PARAMETER_COMPONENT_NAMES = new Set(['model_parameters', 'parameters', PHLYNX_INSTANCE_PARAMETERS_COMPONENT_NAME])
export const GLOBAL_PARAMETER_COMPONENT_NAMES = new Set(['parameters_global', PHLYNX_GLOBAL_PARAMETERS_COMPONENT_NAME])
